...
public class Aggregation
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> data = env.readTextFile("/src/resources/avg1");
        ...
        mapped.keyBy(0).sum(3).writeAsText("/src/resources/out1");

        mapped.keyBy(0).min(3).writeAsText("/src/resources/out2");

        mapped.keyBy(0).minBy(3).writeAsText("/src/resources/out3");

        mapped.keyBy(0).max(3).writeAsText("/src/resources/out4");

        mapped.keyBy(0).maxBy(3).writeAsText("/src/resources/out5");
        // execute program
