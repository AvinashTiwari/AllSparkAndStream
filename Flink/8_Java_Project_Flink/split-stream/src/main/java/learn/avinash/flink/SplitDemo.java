...
public class SplitDemo
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> text = env.readTextFile("/src/main/resources/oddeven");
        ...
        evenData.writeAsText("/src/main/resources/even");
        oddData.writeAsText("/src/main/resources/odd");
