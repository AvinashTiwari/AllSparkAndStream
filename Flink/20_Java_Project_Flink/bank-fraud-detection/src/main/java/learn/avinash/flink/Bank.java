...
public class Bank
{
   ...
   new MapStateDescriptor<String, AlarmedCustomer>("alarmed_customers", BasicTypeInfo.STRING_TYPE_INFO, Types.POJO(AlarmedCustomer.class));
	...
	DataStream<AlarmedCustomer> alarmedCustomers =	 env.readTextFile("/src/resources/alarmed_cust.txt")
	...
	DataStream<LostCard> lostCards = env.readTextFile("/src/resources/lost_cards.txt")
