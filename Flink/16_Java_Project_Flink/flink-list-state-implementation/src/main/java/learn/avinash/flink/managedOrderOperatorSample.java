...
public class managedOrderOperatorSample implements SinkFunction<Tuple2<String, Integer>>,  CheckpointedFunction
{
    ...
    public managedOrderOperatorSample(int threshold)
    {
