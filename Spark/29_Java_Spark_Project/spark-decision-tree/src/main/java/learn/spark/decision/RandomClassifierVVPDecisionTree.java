...
public class RandomClassifierVVPDecisionTree {
    ...
    public static void main(String[] args) {
       ...
       // countryIndexs.show();
        ...
        Dataset<Row> prediction2 = rfModel.transform(holdOutData);
        prediction2.show();
        System.out.println(rfModel.toDebugString());
        System.out.println("The accuracy of the random model is " + evaluator.evaluate(prediction2));
